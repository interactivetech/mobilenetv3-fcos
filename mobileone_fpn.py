...
class MobileOne(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """ Apply forward pass. """
        '''
        stage0:  torch.Size([1, 64, 112, 112])
        stage1:  torch.Size([1, 192, 56, 56])
        stage2:  torch.Size([1, 448, 28, 28])
        stage3:  torch.Size([1, 896, 14, 14])
        stage4:  torch.Size([1, 2048, 7, 7])
        gap:  torch.Size([1, 2048, 1, 1])
        '''
        ...
        # x = x.view(x.size(0), -1)
        # x = self.linear(x)
        return OrderedDict([(ind,f) for ind,f in enumerate([stage0,stage1,stage2,stage3,stage4])])
